...
\newcommand{\thisauthor}{
  Thomas Pinheiro de Souza, Stefan Schintler and Andreas Steinkellner
}          % author
% \newcommand{\thisauthor}{Keith Andrews, Tom Black, and Harry White}      % multiple authors
\newcommand{\thiskeywords}{
  survey paper, webgpu, webgl, interactive, graphics
}   % keywords

\newcommand{\thisdate}{11 Dec 2022}  % date of this version
