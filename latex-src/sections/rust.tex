...
\begin{figure}[tp]
  \centering
  \rust{../rust-example/wasm/Cargo.toml}
...
\begin{figure}[tp]
  \centering
  \rustsnippet{165}{178}{../rust-example/wasm/src/lib.rs}
...
\begin{figure}[tp]
  \centering
  \rustsnippet{23}{51}{../rust-example/wasm/src/lib.rs}
...
\begin{figure}[tp]
  \centering
  \rust{../rust-example/wasm/src/shader.wgsl}
...
\begin{figure}[tp]
  \centering
  \rustsnippet{53}{65}{../rust-example/wasm/src/lib.rs}
...
\begin{figure}[tp]
  \centering
  \rustsnippet{181}{192}{../rust-example/wasm/src/lib.rs}
