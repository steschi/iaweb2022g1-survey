...
Listing \ref{code:three-scene} shows the required setup for a simple
scene in Three.js. 
...
\lstinputlisting[ float=tp, xleftmargin=0cm,
  ...
  caption={[Code Snippet: Three.js Example] { Scene, camera and WebGPU
...
Similar to Three.js it is possible to create an example scene quite
...
\begin{samepage}
  \lstinputlisting[ float=tp, xleftmargin=0cm,
    ...
    xrightmargin=0cm,             % no extra margins for floats
    basicstyle=\footnotesize\ttfamily, frame=shadowbox, numbers=left,
    caption={[Code Snippet: Babylon Example] { Scene, camera and WebGPU
