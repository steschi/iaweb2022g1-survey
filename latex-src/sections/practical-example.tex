...
\begin{listing}
  ...
  \centering
  \code{../software/packages/shared/src/vertex.ts}
...
\begin{listing}
  \centering
  \codesnippet{4}{22}{typescript}{../software/packages/webgpu-simple/src/helpers.ts}
...
\begin{listing}
  ...
  \codesnippet{1}{19}{glsl}{../software/packages/webgpu-simple/src/shader.wgsl}
...
\begin{listing}
  ...
  \centering
  \codesnippet{11}{70}{typescript}{../software/packages/webgpu-simple/src/main.ts}
